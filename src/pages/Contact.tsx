      ...
      <div className="row g-4">
        <div className="col-md-6">
          <div className="list-group">
            <a className="list-group-item list-group-item-action border-success" href={`mailto:${data.links.email}`}>
              <i className="bi bi-envelope me-2" /> {data.links.email}
            </a>
            {data.links.github && (
              <a className="list-group-item list-group-item-action border-success" href={data.links.github} target="_blank" rel="noreferrer">
